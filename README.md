...
- **v1.8.104 – v1.8.111** (2026-05-17/18) — seventh-pass audit closure and first follow-up slice: app-declared `IME_FLAG_NO_PERSONALIZED_LEARNING` and `EXTRA_IS_SENSITIVE` privacy flags are honoured, voice handoff refuses sensitive fields and exposes a durable Listening state, dangerous voice remove commands were tightened, clipboard backup/clear-all leaks were closed, provider-backed clipboard media clones now cap image/video bytes, and image preview decode rejects oversized dimensions before allocation. ([latest notes](RELEASE_NOTES_v1.8.111.md))
...
🚀 **Active development.** Current release: **v1.8.111** (2026-05-18). Migration window for SwiftKey users closes **2026-05-31** — 13 days from this release.
