...
| Area | What's in v1.8.137 | Privacy posture |
|------|-------------------|-----------------|
...
🚀 **Active development.** Current release: **v1.8.137** (2026-05-18). Migration window for SwiftKey users closes **2026-05-31** — 13 days from this release.
