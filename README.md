...
| **MCP daemon bridge** | AIDL client bridge to user-installed MCP daemons with per-daemon enable / disable in Settings → MCP daemon bridge | Local Binder; packages requesting network permissions are rejected before trust or binding |
