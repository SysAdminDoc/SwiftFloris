...
| Area | What's in v1.8.81 | Privacy posture |
|------|-------------------|-----------------|
...
| **Addon packs** | Addon manifest/enumerator contracts, signing-certificate pin reconciliation, dictionary-pack descriptor validation, provenance reports, and a typed dictionary-pack catalog foundation | No-network addon rejection |
...
🚀 **Active development.** Current release: **v1.8.81** (2026-05-17). Migration window for SwiftKey users closes **2026-05-31** — 14 days from this release.
