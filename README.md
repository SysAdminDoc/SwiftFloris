...
| Area | What's in v1.9.58 | Privacy posture |
|------|-------------------|-----------------|
...
| **MCP daemon bridge** | AIDL client bridge to user-installed MCP daemons with per-daemon enable / disable in Settings → MCP daemon bridge | Local Binder; a package may hold only allowlisted permissions — network, SMS, Bluetooth and nearby-devices transports are all rejected before trust or binding |
...
🚀 **Active development.** Current release: **v1.9.58** (2026-08-02). The SwiftKey account export window closed on **2026-05-31**; local/on-device migration paths remain documented above.
