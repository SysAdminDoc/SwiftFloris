...
| Area | What's in v1.8.145 | Privacy posture |
|------|-------------------|-----------------|
...
- [`ROADMAP.md`](ROADMAP.md) — current and historical roadmap (v5.42).
...
🚀 **Active development.** Current release: **v1.8.145** (2026-05-18). Migration window for SwiftKey users closes **2026-05-31** — 13 days from this release.
