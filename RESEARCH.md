...
- Test and documentation gaps: no strict public-release freshness gate; no link-drift gate for trust docs; no addon APK fixture project; no layout JSON lint command; no exported privacy proof bundle test.
