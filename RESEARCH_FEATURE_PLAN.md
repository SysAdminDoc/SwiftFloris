...
- [ ] **P0** — F17 — **Resolve "Neural coming soon" glide-engine entry** at `strings.xml:978`. Either ship the engine or delete the enum value + string. Touches: `strings.xml`, `app/AppPrefs.kt`, `ime/text/gestures/`. Acceptance: no UI shows an unwirable option. Complexity: S.
