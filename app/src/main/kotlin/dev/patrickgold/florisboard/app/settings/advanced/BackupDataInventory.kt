...
object BackupDataInventory {
    val entries: List<BackupDataEntry> = listOf(
        ...
        BackupDataEntry(
            id = "snippets",
            domain = BackupDomain.File,
            path = BackupArchiveStores.SnippetsDirName,
            disposition = BackupDisposition.Included,
            section = BackupSection.Snippets,
        ),
        BackupDataEntry(
            id = "hardware_keyboard_layouts",
            domain = BackupDomain.File,
            path = BackupArchiveStores.HardwareKeyboardLayoutFileName,
            disposition = BackupDisposition.Included,
            section = BackupSection.HardwareKeyboardLayouts,
        ),
        BackupDataEntry(
            id = "custom_emoji_tags",
            domain = BackupDomain.File,
            path = BackupArchiveStores.CustomEmojiTagsFileName,
            disposition = BackupDisposition.Included,
            section = BackupSection.CustomEmojiTags,
        ),
        BackupDataEntry(
            id = "emoji_pin_groups",
            domain = BackupDomain.File,
            path = BackupArchiveStores.EmojiPinGroupsFileName,
            disposition = BackupDisposition.Included,
            section = BackupSection.EmojiPinGroups,
        ),
        BackupDataEntry(
