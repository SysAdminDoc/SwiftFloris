...
object SettingsSearchIndex {
    val entries = listOf(
        ...
        entry("typing.offensive-slurs", R.string.settings__typing__title, R.string.pref__suggestion__block_slurs_only__label, R.string.pref__suggestion__block_slurs_only__summary, SettingsSearchDestination.TYPING),
        ...
        entry("typing.autocorrect-threshold", R.string.settings__typing__title, R.string.pref__correction__auto_correct_confidence_threshold__label, R.string.pref__correction__auto_correct_confidence_threshold__summary, SettingsSearchDestination.TYPING, "confidence conservative aggressive replacement"),
        ...
        entry("typing.auto-correct-confidence-threshold", R.string.settings__typing__title, R.string.pref__correction__auto_correct_confidence_threshold__label, destination = SettingsSearchDestination.TYPING),
        entry("typing.block-slurs-only", R.string.settings__typing__title, R.string.pref__suggestion__block_slurs_only__label, destination = SettingsSearchDestination.TYPING),
