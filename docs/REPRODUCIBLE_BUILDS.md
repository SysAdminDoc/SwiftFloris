...
git clone --branch v1.9.59 --depth 1 https://github.com/SysAdminDoc/SwiftFloris.git
cd SwiftFloris
...
APK_PUBLISHED=app-release-v1.9.59.apk
...
CurrentVersion: "1.9.59"
CurrentVersionCode: 2108
```
