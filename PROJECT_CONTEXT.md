...
**v1.8.104 - v1.8.221** ships the seventh research-pass privacy,
...
diagnostic hardening, root-doc source-of-truth cleanup, and the settings-search
catalog drift guard.
...
v1.8.171 through v1.8.221 refresh the release front door after the 2026-05-31
...
roadmap/completed/changelog source-of-truth contract, and add a real-resource /
typed-route drift guard for settings search.
