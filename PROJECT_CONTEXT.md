...
**v1.8.104 - v1.8.222** ships the seventh research-pass privacy,
...
v1.8.171 through v1.8.222 refresh the release front door after the 2026-05-31
...
typed-route drift guard for settings search, and give zero-result searches a
one-tap path back to Settings Home.
