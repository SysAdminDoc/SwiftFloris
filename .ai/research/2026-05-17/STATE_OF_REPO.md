...
HEAD to v1.8.76. The notable dependency deltas are
...
hardware-keyboard import stack, and v1.8.76 adds the Android runtime mapper
for imported hardware-keyboard layouts.
...
hardware-keyboard runtime mapper shipped in v1.8.76.
...
- 92 tags in repo after the v1.8.76 release tag; local release tags now run
  through `v1.8.76`. Push remains a maintainer-host task because this VM
...
- **Tag cadence:** ~50 patch releases in May 2026 alone (v1.8.16 … v1.8.76).
  The local tag stream was recovered through `v1.8.76`; future release notes
