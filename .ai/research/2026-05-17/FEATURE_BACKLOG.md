...
| **HeliBoard dictionary downloader UI** for user-supplied n-gram packs | Partially shipped v1.8.81-v1.8.82 for the Next-10.3a/b addon catalog + persisted signing-pin foundation (`AddonRegistry`, `DictionaryPackCatalog`, `AddonSigningPinSet`, `prefs.addon.signingCertPins`); startup persistence wiring, Settings UI / install-hint list, and asset mounting remain |
